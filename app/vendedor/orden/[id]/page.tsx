  ...
  return (
    <div>
      <div className="max-w-4xl mx-auto p-4">
        {esNuevo && (
          <div className="bg-green-50 border border-green-200 text-green-800 px-3 py-2 rounded-md mb-6 flex items-center gap-2 text-sm">
        ...
        <div className="card p-8" ref={remitRef}>
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold">NEO MERCADO</h2>
